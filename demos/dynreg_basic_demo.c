...
char *product_key       = "k24eydfvqnO";
char *device_name       = "test54321";
char *product_secret    = "Orn3y2SPYvLJQBks";
...
int main(int argc, char *argv[])
{
    ...
    if (res < STATE_SUCCESS) {
        ...
        printf("please check variables like produt_key, device_name, product_secret in demo\r\n");
        return -1;
    }
